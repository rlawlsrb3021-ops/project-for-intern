...
모델이 고장이라고 판명한 것 중에 진짜 고장 비율이 0.83

실제 고장 중에 모델이 고장이라고 찾은 비율이 0.56
...
따라서 본 분석에서 특정 변수에서 각 구간에 따른 발생 횟수 분석과 주어진 데이터로 6종류의 변수의 상대적 중요도와 failure분류할 수 있는 가능성에 대해 생각할 수 있는 데 의의를 두었다
